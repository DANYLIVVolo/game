...
background=pygame.image.load("pixel-rain-abstract-background_23-2148370435.jpg")
...
class GameSprite():
    ...
    def update(self):
        ...
        if event.keys==pygame.K_d:
            self.x+=self.step    
player=GameSprite(100,100,100,100,10,"png-transparent-cartoon-brawl-stars-kids-thumbnail.png")       
game=True
while game:
